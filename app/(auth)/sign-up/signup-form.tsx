...
const SignUpForm = () => {
  ...
  return (
    <div className='fixed w-[calc(100%-32px)] max-h-[90vh] overflow-auto max-w-[448px] top-1/2 left-1/2 -translate-1/2 grid gap-8 px-5 py-8 rounded-xl bg-neutral-0 dark:bg-neutral-800 dark:border dark:border-neutral-500 md:px-8 md:py-10 md:gap-10'>
      ...
      <form action=''>
        <FieldGroup className='gap-4'>
          <Field className='gap-[6px]'>
            <FieldLabel
              htmlFor='fullname'
              className='gap-[2px] text-sm font-medium leading-base tracking-normal text-neutral-900 dark:text-neutral-0'
            >
              Full Name<span className='dark:text-neutral-100'>*</span>
            </FieldLabel>
            <Input
              id='fullname'
              type='text'
          ...
          <Field className='gap-[6px]'>
            <FieldLabel
              ...
              className='gap-[2px] text-sm font-medium leading-base tracking-normal text-neutral-900 dark:text-neutral-0'
            >
              Email<span className='dark:text-neutral-100'>*</span>
            </FieldLabel>
            <Input
              id='email'
              type='email'
          ...
          <Field className='gap-[6px]'>
            <FieldLabel
              ...
              className='gap-[2px] text-sm font-medium leading-base tracking-normal text-neutral-900 dark:text-neutral-0'
            >
              Password<span className='dark:text-neutral-100'>*</span>
            </FieldLabel>
            <Input
              id='password'
              type='password'
          ...
          <Field>
            <Button className='relative z-2 cursor-pointer h-[46px] rounded-lg bg-teal-700 text-base font-semibold leading-snug tracking-normal text-neutral-0 inset-shadow-[0px_1px_0px_1px] inset-shadow-neutral-0/12 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900 dark:focus-visible:border-neutral-800 dark:focus-visible:border-2 dark:focus-visible:outline-neutral-100'>
              Create account
            </Button>
          </Field>
        </FieldGroup>
